...
トップページ  
<img src="screenshot/toppage.png" alt="top-page" width="70%" />

キャラ作成ページ  
<img alt="chara-create" src="screenshot/chara-create.png" width="70%" />

Discord Bot ダイスロール コマンド  
<img alt="diceroll" src="screenshot/diceroll.png" />

Discord Bot キャラクター情報 編集機能  
<img alt="discord-chara" src="screenshot/discord-chara.png" width="60%" />
