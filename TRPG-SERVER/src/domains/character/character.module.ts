...
@Module({
  ...
  providers: [CharacterService, CharacterRepository, CharacterEventHandlerService, CharacterIdService],
  exports: [CharacterService, CharacterRepository, CharacterEventHandlerService, CharacterIdService]
})
