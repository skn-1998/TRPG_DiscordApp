...
import { SlashCommandBuilder, CommandInteraction, AutocompleteInteraction, ChannelType, TextChannel } from 'discord.js'
...
export class UserDefinedDiceService extends BaseCommandService implements discordCommandType {
  ...
  async execute(interaction: CommandInteraction): Promise<void> {
    ...
    this.logger.debug('ユーザー定義ダイステーブル実行', { channelId, channelName: channel?.name })
