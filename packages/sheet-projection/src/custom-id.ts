...
export const ROLL_PALETTE_CUSTOM_ID_PATTERN = new RegExp(
  `^${ROLL_PALETTE_CUSTOM_ID_PREFIX}(${CUSTOM_ID_CHANNEL_SOURCE})_(${CUSTOM_ID_SAFE_TOKEN_SOURCE})$`
)
export const RESOURCE_DELTA_CUSTOM_ID_PATTERN = new RegExp(
  `^${RESOURCE_DELTA_CUSTOM_ID_PREFIX}(${CUSTOM_ID_CHANNEL_SOURCE})_(${CUSTOM_ID_SAFE_TOKEN_SOURCE})_(${CANONICAL_RESOURCE_DELTA_SOURCE})$`
)
...
export const HUB_PANEL_CUSTOM_ID_PATTERN = new RegExp(
  `^${HUB_PANEL_CUSTOM_ID_PREFIX}(${CUSTOM_ID_CHANNEL_SOURCE})_(${CUSTOM_ID_SAFE_TOKEN_SOURCE})_(${CUSTOM_ID_PAGE_SOURCE})$`
)
