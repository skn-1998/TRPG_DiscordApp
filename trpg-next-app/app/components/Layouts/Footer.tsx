...
import { ActionIcon, Container, darken, Divider, Group, Stack, Text, useMantineTheme } from '@mantine/core'
import { IconBrandGithub, IconBrandTwitter, IconDice6, IconMail } from '@tabler/icons-react'
